...
const SuiteCreatePage = createLazyRouteComponent(() => import('@/pages/dashboard/suite-editor'), 'SuiteCreatePage')
const SuiteEditPage = createLazyRouteComponent(() => import('@/pages/dashboard/suite-editor'), 'SuiteEditPage')
